                ...
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <form method="POST" action="add-cart.php?id=<?php echo $id; ?>">
                           ...
                           <?php if($count > 0) : ?>
                           <button name="submit" type="submit" class="btn btn-primary py-3 px-5 mt-2" disabled>Ajouté au panier</button>
                           <?php else : ?>
                            <button name="submit" type="submit" class="btn btn-primary py-3 px-5 mt-2">Ajouter au panier</button>
                            <?php endif; ?>
                        <?php endif; ?>
                        </form>
                    </div>
