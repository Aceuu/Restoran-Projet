                ...
                <div class="container text-center my-5 pt-5 pb-4">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            ...
                            <li class="breadcrumb-item"><a href="#">Écrire un temoignage</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row g-0">
                ...
                <div class="col-md-6 bg-dark d-flex align-items-center">
                    <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <h1 class="text-white mb-4">Temoignage</h1>
                            ...
                            <div class="row g-3"> 
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        ...
                                        <label for="message">Soumettre un temoignage</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <button name="submit" class="btn btn-primary w-100 py-3" type="submit">Soumettre temoignage</button>
                                </div>
                            </div>
                        </form>
                    </div>
