...
define("APPURL", "http://localhost:8888/restoran/");
define("APPIMAGES", "http://localhost:8888/restoran/admin-panel/foods-admins/foods-images");
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0 pe-4">
                        ...
                        <a href="<?php echo APPURL; ?>/booking.php" class="nav-item nav-link">Réservation</a>
                        <a href="<?php echo APPURL; ?>/food/cart.php" class="nav-item nav-link"><i class="fa-sharp fa-solid fa-cart-shopping"></i>Panier</a>
                        ...
                        <a class="dropdown-item" href="<?php echo APPURL; ?>/users/bookings.php">Mes réservations</a></li>
                        <li><a class="dropdown-item" href="<?php echo APPURL; ?>/users/orders.php">Mes commandes</a></li>
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item" href="<?php echo APPURL; ?>/auth/logout.php">Logout</a></li>
                        </ul>
                        </li>
                        <?php else : ?>
                        <a href="<?php echo APPURL; ?>/auth/login.php" class="nav-item nav-link">Connexion</a>
                        <a href="<?php echo APPURL; ?>/auth/register.php" class="nav-item nav-link">Inscription</a>
                        <?php endif; ?>
                    </div>
